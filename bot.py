    ...
    def __init__(self, order_id, reviewer_id):
        ...
        async def callback(interaction):
            ...
            try:
                ...
                used_now = weekly_points(o['claimer_id'])
...
class OrderView(discord.ui.View):
    ...
    async def claim(self, interaction):
        ...
        used_now = weekly_points(interaction.user.id)
        remaining_now = max(0, WEEKLY_POINT_LIMIT - used_now)
        try:
...
class Bot(commands.Bot):
    ...
    async def setup_hook(self):
        # Databáze se musí inicializovat při KAŽDÉM startu kontejneru.
        # CREATE TABLE IF NOT EXISTS zachová všechna existující data.
        init_db()
